...
<h2>Tools made in spare time</h2>
 ...
 - [github.com/ReeganExE/quick-res](https://github.com/ReeganExE/quick-res) - `res.json(), res.text()` for Edge workers <sup>(Serverless Workers)</sup>
 ...
 - [npmjs.com/package/multi-layers-cache](https://npmjs.com/package/multi-layers-cache) - Multi layers cache <sup>(Serverless Workers)</sup>
